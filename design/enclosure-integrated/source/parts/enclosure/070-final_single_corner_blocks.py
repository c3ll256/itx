...
publish('front_panel', front_panel, 'Single front corner blocks without skin patches')
publish('rear_panel', rear_panel, 'Single rear corner blocks without skin patches')
print(f'FINAL_SINGLE_CORNERS_PASS: {rebuilt_corner_count} compact {final_corner_width_x:.0f}x{final_corner_depth_y:.0f}x{final_corner_height_z:.0f} mm blocks rebuilt once; cleanup remains fully inside the final panel datum.')