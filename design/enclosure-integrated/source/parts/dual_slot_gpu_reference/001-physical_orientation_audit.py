...
# bracket-inclusive length datum. The previously modeled 8-pin location was an
# inaccurate visual proxy, so connector placement is intentionally excluded
# from this geometry audit per the user's physical confirmation.
...
# measured body feature must stay inside the shorter cooler/shroud envelope.
...
print(
    ...
    f'fingers up and fans on outer -X face; inaccurate 8-pin location proxy excluded.'
)