...
- 最终检查重点：三个实际主板支撑点（不要把四个主板孔参考环计作支撑）、AXP120-X67 的 2.0 mm 侧向间隙与 1.2 mm 局部网筋深度、实测 GPU 249.8 mm 总包络、106 mm PCIe 开口、GPU 托架与供电区、SFX 插入、左上角电源按钮孔、双 80 mm 与单 120 mm 圆头格栅的连续外圈/打印筋/标准固定孔，以及六面板装配完整性。
